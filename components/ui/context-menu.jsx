...
function ContextMenuSubTrigger(props) {
  const { className, inset, children, iconClassName, ...restProps } = props;
...
function ContextMenuContent(props) {
  const { className, overlayClassName, overlayStyle, portalHost, ...restProps } = props;
  return (
...
function ContextMenuItem(props) {
  const { className, inset, variant, ...restProps } = props;
  return (
    <TextClassContext.Provider
      value={cn(
